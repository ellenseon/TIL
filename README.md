...
개발 노트와 학습 기록을 담는 Velog 스타일의 정적 블로그입니다.

## 특징

- 🎨 **Velog 스타일 디자인**: 깔끔하고 모던한 UI/UX
- 📚 **시리즈 기능**: 관련 포스트를 시리즈로 묶어 관리
- 🏷️ **태그 시스템**: 태그별 포스트 필터링 및 검색
- 🌙 **다크모드 우선**: 눈에 편안한 다크 테마
- 💻 **코드 하이라이팅**: GitHub 스타일 Prism 코드 하이라이팅
- 🔍 **Lunr 검색**: 클라이언트 사이드 검색 기능
- 📡 **RSS 피드**: 블로그 구독을 위한 RSS 지원
- 📱 **반응형 디자인**: 모바일, 태블릿, 데스크톱 최적화
- 🔗 **소셜 공유**: Twitter, Facebook, LinkedIn 공유 및 URL 복사
- 📝 **드래프트 기능**: 작성 중인 포스트 임시 저장
- 🚫 **광고/추적기 없음**: 깔끔한 블로깅 경험
